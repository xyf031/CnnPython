...
def parse_args():
    ...
    parser.add_argument('--folder', dest='folder_path',
                        ...
                        default='/home/xyf/ssd/histeqMRC/trpv1-histeq', type=str)
    parser.add_argument('--net', dest='caffemodel',
                        help='model to test',
                        default="output/store/trpv1-histeq/mrc_caffenet_iter_30000.caffemodel", type=str)
...
if __name__ == '__main__':
    ...
    cfg.TEST.MAX_AVG_IMAGE = 300
    cfg.TEST.MAX_PER_IMAGE = 600
